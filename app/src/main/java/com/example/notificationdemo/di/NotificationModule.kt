...
object NotificationModule {
    ...
    fun provideNotificationBuilder(
        ...
        val encodedUrl = URLEncoder.encode("https://grubhub.com", StandardCharsets.UTF_8.toString())
        val clickIntent = Intent(
            Intent.ACTION_VIEW,
            "$MY_URI/$MY_ARG=$encodedUrl".toUri(),
            context,
        ...
        return NotificationCompat.Builder(context, "Main Channel ID")
            .setContentTitle("GH Direct Pro!")
            .setContentText("Go to Grubhub WebView")
